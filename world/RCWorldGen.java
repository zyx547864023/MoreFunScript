...
import real_combat.world.systems.RC_AtLeastOne;

import java.util.ArrayList;

public class RCWorldGen implements SectorGeneratorPlugin {
    ...
    public void generate(SectorAPI sector) {
        ...
        new RC_AtLeastOne().generate(sector);
