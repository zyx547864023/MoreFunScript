...
public class RC_CamouflageNetRenderingPlugin extends BaseCombatLayeredRenderingPlugin {
    private final static String ID = "RC_CamouflageNetRenderingPlugin";
    private final static Color FRINGE = new Color(138, 0, 0, 255);
    private final static Color CORE =  new Color(0,0,0, 255);
    private final static float THICKNESS = 20f;
    private final static String CAMOUFLAGENET_LIST="CAMOUFLAGENET_LIST";
    public final static float DISTANCE = 11f;
