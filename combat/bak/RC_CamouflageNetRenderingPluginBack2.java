        ...
        if (!engine.isPaused()) {
            ...
            //if (tracker.intervalElapsed()) {
                if (engine.getCustomData().get(CAMOUFLAGENET_LIST) != null) {
                    ...
                    for (RC_CamouflageNetOnHitEffect.CamouflageNet c : camouflageNetList) {
                        ...
                        if (engine.getCustomData().get(c+"EMPARCENTITY_LIST") != null) {
                            ...
                            for (EmpArcEntityAPI e:empList) {
                                e.getLocation().set(e.getLocation().getX() * (1.08f), e.getLocation().getY() * (1.08f));
                                e.getTargetLocation().set(e.getTargetLocation().getX() * (1.08f), e.getTargetLocation().getY() * (1.08f));
                            }
                        }
                        else {
                    ...
                    for (RC_CamouflageNetOnHitEffect.CamouflageNet c:removeList) {
