package real_combat.missions.rc_tester;
...
//		api.getDefaultCommander(FleetSide.PLAYER).getStats().setSkillLevel(Skills.ELECTRONIC_WARFARE, 3);
        ...
        if (!testMode) {
            api.addToFleet(FleetSide.PLAYER, "hyperion_meta_variant", FleetMemberType.SHIP, "海波龙原型", false);
            api.addToFleet(FleetSide.PLAYER, "hyperion_meta_variant_d", FleetMemberType.SHIP, "海波龙原型", false);
            api.addToFleet(FleetSide.PLAYER, "hyperion_meta_variant_n", FleetMemberType.SHIP, "海波龙原型", false);
            api.addToFleet(FleetSide.PLAYER, "hyperion_plus_variant", FleetMemberType.SHIP, "海波龙", false);
